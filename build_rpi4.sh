...
make image  PROFILE="rpi-4" \
           PACKAGES="bash kmod-rt2800-usb rt2800-usb-firmware kmod-cfg80211 kmod-lib80211 kmod-mac80211 kmod-rtl8192cu \
                     ...
                     openvpn-openssl luci-app-openvpn watchcat openssh-sftp-client kmod-usb-storage-extras \
                     ...
                     irqbalance ethtool netperf speedtest-netperf iperf3 cfdisk \
                     curl wget rsync file htop lsof less mc tree usbutils bash diffutils \
                     openssh-sftp-server nano luci-app-ttyd kmod-fs-exfat ntfs-3g \
                     kmod-usb-storage-uas block-mount luci-app-minidlna kmod-fs-ext4 \
                     urngd usign vpn-policy-routing wg-installer-client wireguard-tools \
                     kmod-usb-core kmod-usb3 dnsmasq dropbear e2fsprogs \
                     zlib firewall4 wireless-regdb f2fsck openssh-sftp-server wget-ssl \
                     kmod-usb-wdm kmod-usb-net-ipheth usbmuxd kmod-usb-net-asix-ax88179 \
                     kmod-usb-net-cdc-ether mount-utils kmod-rtl8xxxu kmod-rtl8187 lsblk \
                     kmod-rtl8xxxu rtl8188eu-firmware kmod-rtl8192ce kmod-rtl8192cu kmod-rtl8192de luci-compat \
