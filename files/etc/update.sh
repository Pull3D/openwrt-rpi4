...
[ is_connected ] && {
   ...
   opkg install dnsmasq dropbear firewall fstools fuse3-utils fwtool getrandom git glib2 gnupg hostapd-common ip-full ip6tables ipset iptables-nft iw iwinfo jshn adblock luci-app-adblock wwan iwlwifi-firmware-iwl6000g2
